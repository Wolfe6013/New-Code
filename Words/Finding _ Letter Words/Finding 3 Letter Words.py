import random
import time
#there is 17,576 possible combinations (26^3)
timesdone = 0
...
while wanttodo > timesdone:
    ...
    print("Check",timesdone+1," ",letter1+ letter2+ letter3)
    time.sleep(wait/1000)
    if FirstLetter == letter1 and SecondLetter == letter2 and ThirdLetter == letter3:
        print("Done!!!")
        timesdone = wanttodo 
        found = 1
